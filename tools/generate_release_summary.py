...
def generate_summary(version: str, dist_dir: Path) -> str:
    ...
    return "\n".join(
        [
            ...
            "| --- | --- | --- |",
            "| Lock freshness | pass | release workflow `uv lock --check` |",
            "| Headless wheel smoke | pass | release workflow smoke test |",
            "",
            "## Correctness",
            "",
            ...
            "| Area | Result | Evidence |",
            "| --- | --- | --- |",
            "| Router benchmark regression gate | "
            f"{_present(dist_dir / 'router-release-regressions.md')} | `router-release-regressions.md` |",
